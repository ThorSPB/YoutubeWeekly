...
TRANSLATIONS = {
    "en": {
        ...
        "status_downloading_override": "Downloading the video set by the developer for {name}...",
    ...
    "ro": {
        ...
        "status_downloading_override": "Se descarcă videoclipul stabilit de dezvoltator pentru {name}...",
